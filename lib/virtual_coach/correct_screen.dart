...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: CorrectScreen(video: video, movement: movement),
    );
  }
}
...
class CorrectScreen extends StatefulWidget {
  ...
  const CorrectScreen({required this.video, required this.movement});
  @override
  _CorrectScreenState createState() => _CorrectScreenState(videoPath: video);
}
...
class _CorrectScreenState extends State<CorrectScreen> {
  ...
  _CorrectScreenState({required this.videoPath});
